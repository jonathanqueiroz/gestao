...
<form action="<?php echo base_url('Instituicao/cadastrarDepartamento'); ?>" method="post">
	...
	<div class="row passo1 form_cadastro form_box">
			...
			<div class="col s12 l2 ">
				...
				<option value="feminino">Rio Grande do Norte</option>
				<option value="masculino">Mato Grosso do Sul</option>
				</select>
			</div>
			<div class="col s12 l2 " >
