...
<?php $atributo = array('id' => 'edit1', 'name' => 'form1'); 
	echo form_open('Pessoa/edit_dados_adolescente/'.$id, $atributo); ?>
	<?php ?>
	<div class="row passo1 form_cadastro form_box">
			...
			<br>
			<button class="btn waves-effect waves-light blue" type="submit" name="edit1">Salvar</button>
			<br><br>
		</div>
			<br>
			<br>
